...
{ .mmi;	(p17)	add	te0=2048,te0		// 13[11]/
	(p17)	add	te1=2048+64-1,te1};;	// 13[11]/
{ .mib;	(p0)	xor	t2=t2,te13		// 14[12]/2:done!
	(p17)	add	te2=2048+128-2,te2}	// 14[12]/
{ .mib;	(p0)	xor	t3=t3,te10		// 14[12]/3:done!
	(p17)	add	te3=2048+192-3,te3	// 14[12]/
	br.ctop.sptk	.Le_top		};;
.Le_end:

...
{ .mmi;	add	in0=0,in0
	mov	loc0=psr.um
	add	out11=4*60,in2	};;	// &AES_KEY->rounds
